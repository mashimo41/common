...
#    cv2.imshow("magnitude", dft_A)

    log_spectrum=log_spectrum*log_spectrum*log_spectrum*log_spectrum
    fimage = log_spectrum / np.amax(log_spectrum) * 255
    #cv2.imwrite("IMG_2392_twice_dft.jpg", fimage)
