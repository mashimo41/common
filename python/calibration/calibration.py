...
if __name__ == '__main__':
    ...
    # 調布実験
    img_names_undistort = glob.glob('./*.png')
    img_chess_names = glob.glob('./chessboard/*.png')
    debug_dir = './output/'
    square_size = 1.0
    pattern_size = (10, 7)
    ...
    # コーナー検出・座標取得
    ####################################################
    for fn in img_chess_names:

        # 現在何番目の画像が処理されているか(画像が読み込めない場合は飛ばす)
